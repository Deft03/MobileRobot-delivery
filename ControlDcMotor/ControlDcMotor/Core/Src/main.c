...
void HAL_TIM_PeriodElapsedCallback(TIM_HandleTypeDef *htim)
{
	if (htim -> Instance == TIM2)
	{
		...
		*WL = Average_5_times(CurvelB,sum_B);
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    SP_WL = Trapezoidal_Velocity(Target_pos,PosL,WL,A_max,V_max,T);
		SP_WR = Trapezoidal_Velocity(Target_pos,PosR,WR,A_max,V_max,T);
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
